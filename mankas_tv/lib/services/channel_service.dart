...
class ChannelService {
  ...
  static const guaranteedChannels = [
    ...
    // ── News ──
    Channel(id: 'france24', name: 'France 24', logo: 'https://upload.wikimedia.org/wikipedia/commons/6/65/France_24_logo.svg', streamUrl: 'https://france24-i.akamaihd.net/hls/live/2210328-a/F24_EN_LO_HLS/master.m3u8', category: 'Actualit\u00e9s', country: 'France', language: 'French'),
    ...
    Channel(id: 'ewtn', name: 'EWTN Global Catholic', logo: 'https://img.icons8.com/fluency/512/tv.png', streamUrl: 'https://ewtn-hls.vercel.app/ewtn01.m3u8', category: 'Religion', country: 'USA', language: 'English'),
  ];
