...
class ChannelService {
  ...
  static const guaranteedChannels = [
    ...
    Channel(
      ...
      streamUrl: 'http://a.files.bbci.co.uk/media/live/manifesto/audio_video/simulcast/hls/uk/hls_tablet/ak/bbc_one_london.m3u8',
    ...
    Channel(
      ...
      streamUrl: 'http://a.files.bbci.co.uk/media/live/manifesto/audio_video/simulcast/hls/uk/hls_tablet/ak/bbc_two_england.m3u8',
      category: 'FIFA World Cup 2026',
      country: 'UK',
      language: 'English',
    ),
