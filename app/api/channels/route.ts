...
const guaranteedChannels: Channel[] = [
  ...
  { id: "alkass-one", name: "Alkass One", logo: "https://logovector.net/wp-content/uploads/2013/12/al-kass-sport-channel-logo-vector-2-163055.png", stream_url: "https://liveeu-gcp.alkassdigital.net/alkass1-p/main.m3u8", category: "Sports", country: "Qatar", language: "Arabic", created_at: "" },
  { id: "alkass-two", name: "Alkass Two", logo: "https://logovector.net/wp-content/uploads/2013/12/al-kass-sport-channel-logo-vector-2-163055.png", stream_url: "https://liveeu-gcp.alkassdigital.net/alkass2-p/main.m3u8", category: "Sports", country: "Qatar", language: "Arabic", created_at: "" },
  { id: "alkass-three", name: "Alkass Three", logo: "https://logovector.net/wp-content/uploads/2013/12/al-kass-sport-channel-logo-vector-2-163055.png", stream_url: "https://liveeu-gcp.alkassdigital.net/alkass3-p/main.m3u8", category: "Sports", country: "Qatar", language: "Arabic", created_at: "" },
  { id: "alkass-four", name: "Alkass Four", logo: "https://logovector.net/wp-content/uploads/2013/12/al-kass-sport-channel-logo-vector-2-163055.png", stream_url: "https://liveeu-gcp.alkassdigital.net/alkass4-p/main.m3u8", category: "Sports", country: "Qatar", language: "Arabic", created_at: "" },
  { id: "bbc-one", name: "BBC One", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/BBC_One_logo_2021.svg/960px-BBC_One_logo_2021.svg.png", stream_url: "http://a.files.bbci.co.uk/media/live/manifesto/audio_video/simulcast/hls/uk/hls_tablet/ak/bbc_one_london.m3u8", category: "Sports", country: "UK", language: "English", created_at: "" },
  ...
  { id: "canal-sport", name: "Canal+ Sport", logo: "https://i.imgur.com/EOXnU15.png", stream_url: "http://151.80.18.177:86/Canal+_sport_HD/index.m3u8", category: "Sports", country: "France", language: "French", created_at: "" },
  { id: "canal-foot", name: "Canal+ Foot", logo: "https://upload.wikimedia.org/wikipedia/commons/e/eb/Canal%2BFoot.png", stream_url: "https://test.946985.filegear-sg.me/proxy/ef3174f16d4557d2", category: "Sports", country: "France", language: "French", created_at: "" },
  { id: "ard-erde", name: "ARD (Das Erste)", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/ARD_Dachmarke_2014.svg/960px-ARD_Dachmarke_2014.svg.png", stream_url: "https://daserste-live.ard-mcdn.de/daserste/live/hls/int/master.m3u8", category: "Sports", country: "Germany", language: "German", created_at: "" },
  { id: "telemundo-intl", name: "Telemundo Internacional", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/Telemundo_logo_2018.svg/960px-Telemundo_logo_2018.svg.png", stream_url: "http://138.121.15.230:9002/TELEMUNDO/index.m3u8", category: "Sports", country: "USA", language: "Spanish", created_at: "" },
  { id: "cctv-football", name: "CCTV Storm Football", logo: "https://i.imgur.com/Fy6HkX0.png", stream_url: "http://38.75.136.137:98/gslb/dsdqpub/fyzq.m3u8?auth=testpub", category: "Sports", country: "China", language: "Chinese", created_at: "" },
];
